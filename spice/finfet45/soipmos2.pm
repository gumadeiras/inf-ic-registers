...
+tox = ptbox   toxref = 1.5e-009     tbox = 5e-007   tnom  = 27
...
+u0 = 140	ua =1.6e-9       	ub = 0.5e-018        uc      = -3e-11             


+prwg = 0               prwb = 0               wr      = 1               rdsw    = 550           

+a0 = 1.2		ags = 1e-20       a1      = 0               a2      = 1       
+b0      = -1e-20               b1      = 0               vsat    = 140000           keta    = -0.047             


+ketas   = 0               dwg     = 0               dwb     = 0               dwbc    = 0   

          
+pclm    = 0.55            pdiblc1 = 0.04            pdiblc2 = 0.0075          pdiblcb = 3.4e-8          
...
+ldif0   = 0.001           cgeo    = 0               cgso    = 7.43e-010        cgdo    = 7.43e-010      
